...
describe Game do
  ...
  describe "#move" do
    ...
    it "moves a pawn to a new legal postion" do
      ...
      game.move("b5", "b4")
      game.move("c2", "c4")
      expect(game.move("b4", "c3")).to eql([["♜", "♟︎", " ", " ", " ", " ", "♙", "♖"],
                                            ["♞", "♟︎", " ", " ", " ", " ", " ", "♘"],
                                            ["♝", " ", "♙", " ", " ", " ", "♙", "♗"],
                                            ["♛", "♟︎", " ", " ", " ", " ", "♙", "♕"],
                                            ["♚", "♟︎", " ", " ", " ", " ", "♙", "♔"],
    ...
    it "moves a pawn to a new legal postion" do
      ...
      game.move("g4", "g5")
      game.move("f7", "f5")
      expect(game.move("g5", "f6")).to eql([["♜", "♟︎", " ", " ", " ", " ", "♙", "♖"],
                                            ["♞", "♟︎", " ", " ", " ", " ", "♙", "♘"],
                                            ["♝", "♟︎", " ", " ", " ", " ", "♙", "♗"],
                                            ["♛", "♟︎", " ", " ", " ", " ", "♙", "♕"],
                                            ["♚", "♟︎", " ", " ", " ", " ", "♙", "♔"],
    ...
    it "moves a pawn to a new legal postion" do
      ...
      game.move("g4", "g5")
      game.move("h7", "h5")
      expect(game.move("g5", "h6")).to eql([["♜", "♟︎", " ", " ", " ", " ", "♙", "♖"],
                                            ["♞", "♟︎", " ", " ", " ", " ", "♙", "♘"],
                                            ["♝", "♟︎", " ", " ", " ", " ", "♙", "♗"],
                                            ["♛", "♟︎", " ", " ", " ", " ", "♙", "♕"],
                                            ["♚", "♟︎", " ", " ", " ", " ", "♙", "♔"],
    ...
    it "doesn't move a pawn to an illegal position" do
      ...
      game.move("c7", "c5")
      game.move("c5", "c4")
      expect(game.move("c4", "b3")).to eql("illegal move")
    end
    ...
    it "doesn't move a king to an illegal position" do
      game = Game.new
      expect(game.move("e1", "e2")).to eql("illegal move")
    end

    it "doesn't move a king to an illegal position" do
      game = Game.new
      expect(game.move("e8", "f8")).to eql("illegal move")
    end
  end
end